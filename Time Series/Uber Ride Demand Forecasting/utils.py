"""
Uber Ride Demand Forecasting — Utility Functions
...
VALUE_COL = "pickups"        # raw target column name
...
ROLL_WINDOWS = [7]       # rolling-window sizes
...
def load_data(filepath="data/pickups.csv"):
