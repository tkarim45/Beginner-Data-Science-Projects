...
Classifies SMS messages as spam or ham (not spam) using NLP preprocessing and machine learning. Text is cleaned by removing stopwords and applying stemming, then vectorized with TF-IDF. Multiple classifiers (SVM, and others) are trained and evaluated.
