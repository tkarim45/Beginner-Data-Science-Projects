"""
Regenerate data/sample/ from the HuggingFace dataset `Javtor/rock-paper-scissors`.

Loads the dataset (non-streaming: these ImageFolder datasets have broken
streaming label metadata), shuffles with a fixed seed, and saves up to 300
...
HF="Javtor/rock-paper-scissors"; SPLIT="train"; IMG="image"; LAB="label"; CAP=300
