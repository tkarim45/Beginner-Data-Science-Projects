...
*EfficientNet-B0 is a convolutional neural network (CNN) model from the Google AI EfficientNet family, designed for image classification tasks. It is the B0 variant in the EfficientNet series (B0 to B7), offering the best balance of accuracy and computational efficiency for lightweight deployment.*
...
| B4 to B7  | 19M, 66M    | 380 to 600     | Very high       | Heavy tasks    |
