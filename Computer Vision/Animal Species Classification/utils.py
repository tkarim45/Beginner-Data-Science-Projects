"""
Utility functions for the Animal Species Classification project.

Transfer learning: a frozen ImageNet-pretrained ResNet18 turns each image into a
512-d feature vector, then a logistic-regression classifier is trained on top.
Same recipe as the Fruit Classification project, applied to a harder dataset
(low-resolution 32x32 CIFAR-10 animal photos, upsampled).
"""
